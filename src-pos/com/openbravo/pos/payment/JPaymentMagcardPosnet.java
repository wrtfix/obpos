...
public class JPaymentMagcardPosnet extends javax.swing.JPanel implements JPaymentInterface {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel2);
        jLabel2.setBounds(60, 130, 90, 14);

        jLabel4.setText("Interes");
        jPanel4.add(jLabel4);
        jLabel4.setBounds(110, 170, 35, 14);
        ...
        jTextField1.setBounds(180, 170, 130, 20);

        jTextField2.setEditable(false);
        jPanel4.add(jTextField2);
        jTextField2.setBounds(180, 200, 130, 20);
        ...
        jPanel4.add(jTFCupon);
        jTFCupon.setBounds(180, 280, 130, 20);
        jPanel4.add(jPanel6);
        jPanel6.setBounds(30, 90, 300, 220);
